...
const FrontPage = () => {
    ...
    return(
        <div>
            ...
            <img src={logoImg} class = "logoImg" alt="helping hands logo" width="200" height="200"></img>
            {/* FIXME: place helping hands title next to the logo */}
            <h1 class = "logoText">Helping Hands</h1>
            
            <p class = "motto"><em>Nurturing a better future</em></p>
            ...
            {/* <br></br> */}
            <h1 class = "header">Mission Statement</h1>
            <p class = "body">
                <p class = "mission">Our mission is simple: <strong>To leave the world a better place than we found it.</strong></p>
                <br></br>
            ...
            {/* flexbox */}
            <img src={africaVolunteerImg} class = "galleryImg" alt="volunteers in africa" width="480" height="250"></img>
            <img src={africanPeopleImg} class = "galleryImg" alt="african people" width="466" height="311"></img>
            <br></br>
            <img src={indiaVolunteerImg} class = "galleryImg" alt="volunteers in india" width="474" height="291"></img>
            <img src={languageExchangeImg} class = "galleryImg" alt="language exchange event" width="512" height="341"></img>
            <br></br>
            <img src={plantVolunteerImg} class = "galleryImg" alt="volunteering by planting plants" width="600" height="315"></img>


            <h1 class = "askJoin">Lend a Helping Hand Today!</h1>

            <img src={diverseFriendsImg} class = "bigImg" alt="diverse group of friends" with="915" height="400"></img>
            <p class = "enterAccount"><a href="/log-in">Login</a> or <a href="/sign-up">Create an Account</a></p>
        </div>
